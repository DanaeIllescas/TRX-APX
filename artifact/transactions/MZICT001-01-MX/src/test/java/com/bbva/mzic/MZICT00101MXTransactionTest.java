...
/**
 * Test for transaction MZICT00101MXTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/MZICT00101MXTest.xml" })
public class MZICT00101MXTransactionTest {

	@Autowired
	private MZICT00101MXTransaction transaction;
